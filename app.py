...
def load_data (path):
    ...
    df['District']=df[df['refArea'].str.contains('resource')]
    ...
    columns_to_keep= [
        ...
        'Total number of commercial institutions by size-number of medium institutions',
        'Total number of commercial institutions by size-number of large institutions',
        'Existence of commercial and service activity by type-self employment',
        'Existence of commercial and service activity by type-commerce',
        'Existence of commercial and service activity by type-public sector',
        'Existence of commercial and service activity by type-banking institutions',
        'Existence of commercial and service activity by type-service institutions'
    ]
    df =df[columns_to_keep]
    return df

file_path= r"C:\\Users\\User\\Desktop\\Streamlit assignment\\trade data.csv"
df =load_data(file_path)


df=df.rename(columns={
    'Total number of commercial institutions by size-number of small institutions' : 'Small',
    'Total number of commercial institutions by size-number of medium institutions': 'Medium',
    'Total number of commercial institutions by size-number of large institutions': 'Large',
    'Existence of commercial and service activity by type-self employment': 'Self Employment',
    'Existence of commercial and service activity by type-commerce':'Commerce',
    'Existence of commercial and service activity by type-public sector' : 'Public Sector',
    'Existence of commercial and service activity by type-banking institutions' : 'Banking Institutions',
    'Existence of commercial and service activity by type-service institutions' : 'Service Institutions'
})
