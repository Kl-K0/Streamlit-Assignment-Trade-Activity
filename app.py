...
with st.sidebar:
    ...
    district_view = st.radio(
        ...
        [
            "All Districts",
            "Top 5 Most Active Districts",
            "Bottom 5 Least Active Districts"
        ]
    )

if district_view == "Top 5 Most Active Districts":
    sidebar_districts = (
        district_df
...
elif district_view == "Bottom 5 Least Active Districts":
    sidebar_districts = (
        district_df
